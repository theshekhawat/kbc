...
export class ConstantsService {
  ...
  public static readonly flipQuestionsSetJsonFilePath: string         = './assets/datasource/flip-questions-set-6.json';
  public static readonly questionsSetJsonFilePath: string             = './assets/datasource/questions-set-6.json';
