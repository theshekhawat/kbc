...
export class GameShowUtilitiesService {
  ...
  public lifelineFiftyFiftyLocked:boolean = false;
  public lifelineDoubleChanceLocked:boolean = false;
  public lifelineAskTheAudienceLocked:boolean = false;
  public lifelineFlipTheQuestionLocked:boolean = false;
  public lifelineExtraTimeLocked:boolean = false;
  ...
  parseNumber(stringToBeConverted: string) {
    var stringToBeConverted = stringToBeConverted || "";
    var decimal = '.';
    ...
    if (decimal != "" && (stringToBeConverted.length - stringToBeConverted.indexOf(decimal) - 1 == 3) && stringToBeConverted.indexOf("0" + decimal)!==0) decimal = "";
